...
**Išvados**: 
Saitynų taikomųjų programų projektavimo moduliui buvo sukurta svetainė, skirta padėti knygrišiui skaitmenizuotai valdyti užsakymus, gaminamus ir parduodamus produktus. Buvo suprogramuotos CRUD funkcijos su užsakymais, produktais bei komentarais. Kuriant Backend dalį buvo remiamąsi REST principais, įrankiai, kuriais buvo naudojimąsi - .NET, Entity framework, duomenų bazė - SQL. Frontend dalis buvo sukurta pasinaudojant React biblioteka bei MUI - React komponentų biblioteka. Projekto pabaigoje sudaryta dokumentacija - aprašytas kiekvienas API kreipinys, kokius parametrus reikia paduoti bei koks yra numatomas rezultatas.
